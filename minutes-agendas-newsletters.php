...
/*
Plugin Name: Minutes, Agendas, Newsletters
...
1.0 2011-10-11 Fixes to readme file.
1.1 2012-07-03 Added new options to shortcodes. Some general code cleanup.
1.2 2012-07-04 Fixed error in omit_empty=true case where only some document types were being displayed.
1.3 2022-02-12 Added line breaks for multiple documents in a single month. 
/*
/*
...
if ( !class_exists( 'MinutesAgendasNewsletters' ) ) {
    ...
    function uploadMinutesAgendasNewsletters() {
      ...
      <div class=wrap>
        ...
        <p>Note: Your document must be in pdf format. It will be renamed using the meeting/newsletter date, e.g., Minutes_2019-06-15.pdf.</p>
        ...
        <p><label for="docType">Document type:</label>
          ...
          foreach ($u->document_types as $d=>$docdef) {
            ...
            $radio_group[] = '<br><input type="radio" name="docType" value="'.$value.'"' . $checked . '/> '.$title;
          }
